...
const createTweet = asyncHandler(async (req, res) => {
    ...
    if(!content){
        throw new ApiError(400," Tweet content require")
    }
...
const getUserTweets = asyncHandler(async (req, res) => {
    ...
    const tweet=await Tweet.find({user:userId}).sort({charAt:-1})
...
const updateTweet = asyncHandler(async (req, res) => {
    //TODO: update tweet
        ...
        res.status(200).json(new ApiResponse(200, tweet, "User tweets fetched successfully"));
...
const deleteTweet = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new ApiResponse(200, tweet, "User tweets deleted successfully"));
